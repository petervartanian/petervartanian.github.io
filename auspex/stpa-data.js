// Generated from stpa-[a-f]1.json by build-stpa.mjs.
window.AuspexSTPAModels = {
        ...
        "SAB-2024": {
          ...
          "barriers": {
            "sabotage-review": {
              ...
              "conditionBasis": "A stronger reviewer reduced attacker success in the compared test conditions; residual successful sabotage remained.",
              "limitType": "mixed",
  ...
  "P-01": {
    ...
    "constraints": [
      {
        "id": "SC1",
        "title": "Assure conflicting-command behavior",
      ...
      {
        "id": "SC5",
        "title": "Protect adverse feedback",
        ...
        "MYA-2017": {
          ...
          "barriers": {
            "counter-speech": {
              ...
              "condition": "failed",
              "conditionBasis": "The intervention did not reduce exposure in the activists’ account; the failure concerns ranking interaction.",
              "limitType": "safeguard",
