...
<div class="pv-fasjus-shell" style="text-align: center; display: flex; flex-direction: column; align-items: center;">
  ...
  <div class="pv-fj-below" style="text-align: center; max-width: 900px; margin: 0 auto;">
    ...
    <p class="pv-fj-lede" style="font-variant: small-caps;"><strong>Fas/Jus</strong> studies the &#8220;zone&#8221; where power becomes law and law becomes strategy.</p>

    <div class="pv-fj-split" style="display: flex; justify-content: center; align-items: flex-start; gap: 2rem; width: 100%;">
