...
<div class="education-group" id="honors">
...
<div class="education-group" id="awards">
...
<section class="academic-record"><h4>Distinctions</h4>
<div class="education-group"><ul class="education-list"><li>GPA: 4.00/4.00</li></ul></div>
<div class="education-group"><ul class="education-list">{institution_honors("California Institute of Technology")}</ul></div></section></div>'''
