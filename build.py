...
<section class="academic-record"><h4>Academic record</h4>
<div class="education-group" id="honors"><p class="record-label">Standing</p>
...
<div class="education-group" id="awards"><p class="record-label">Recognition</p>
...
<section class="academic-record"><h4>Academic record</h4>
<div class="education-group"><p class="record-label">Standing</p><ul class="education-list"><li>GPA: 4.00/4.00</li></ul></div>
<div class="education-group"><p class="record-label">Recognition</p><ul class="education-list">{institution_honors("California Institute of Technology")}</ul></div></section></div>'''
